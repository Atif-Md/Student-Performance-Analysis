...
<h2 style="font-size: 30px;"><a href="StudentAttendance.jsp" style="text-decoration: none;"><b> Update Attendance </b></a></h2>
</div>
</div>
<br>
<div class="w3-row " >
<div class="w3-col w3-container w3-quarter w3-white"></div>
<div class="w3-col w3-yellow w3-center w3-half ">
<h2 style="font-size: 30px;"><a href="AttendancePreview.jsp" style="text-decoration: none;"><b> Attendance Display</b></a></h2>
</div>
</div>
</body>
</html>