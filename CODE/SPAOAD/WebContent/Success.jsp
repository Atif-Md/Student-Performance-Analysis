...
<marquee behavior="scroll" dir="ltr" scrollamount="10"><h2 style="font-size: 40px;"><b> Registration  Successfully</b></h2></marquee>
</div>
</div>
</div>
<br>
...
<h2 style="font-size: 30px;"><a href="AdminHome.jsp" style="text-decoration: none;"><b> Admin Home </b></a></h2>
</div>
</div>
</body>
</html>